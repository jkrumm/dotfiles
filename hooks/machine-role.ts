  ...
  switch (backend) {
    case "cache":
      return [
        ...
        "Add `--push` to trigger the approval right away as a native dialog on the MacBook",
        "instead of waiting for `make human-queue` there — still needs a human to click Run, just",
        "sooner. Which refs the",
