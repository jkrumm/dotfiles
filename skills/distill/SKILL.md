...
- Output always goes to the brain repo, as a curated-surface page under the relevant `Projects/` or `Areas/` folder (light discipline — wikilinks must resolve, no forced schema beyond `status`/`source`).
