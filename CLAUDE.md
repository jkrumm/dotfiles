...
**The actual hazard is silent config revert, and it is exactly two packages.**
Both have local machinery bolted on top that an upgrade destroys with no error:
